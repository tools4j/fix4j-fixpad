 ...
 * Time: 5:17 PM
 */
public class NotContainsStringMatcher extends TypeSafeMatcher<Object> {
    private final String substring;

    @Factory
    public static Matcher<Object> doesNotContainText(String text) {
        return new NotContainsStringMatcher(text);
    }

    public NotContainsStringMatcher(String substring) {
        this.substring = substring;
    }

    @Override
    public void describeTo(Description desc) {
        desc.appendText("Node should NOT have substring " + this.substring);
    }
